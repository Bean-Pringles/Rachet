                ...
                if len(node.children) > 0:
                    ...
                    if arg.type == 'StringLiteral':
                        ...
                        if arg.value in self.variables:
                            ...
                            # Append newline
                            newline_label = self.get_unique_label("str_newline")
                            after_newline_label = self.get_unique_label("after_newline")
                            self.generated_text_asm += (
                                f"jmp {after_newline_label}\n"
                                f"{newline_label}: db 10, 0\n"  # 10 = '\n'
                                f"{after_newline_label}:\n"
                                f"push {newline_label}\n"
                                f"call print_thunk\n"
                            )
